...
var initMap = function () {
    map = new google.maps.Map(document.getElementById('MapArea'), {
        center: new google.maps.LatLng(26.359231, 43.981812), zoom: 12, });
...
function finalMarker(marker_info, model) {
    ...
    });google.maps.event.addListener(self.googleMarker, 'click', function () {self.selected();self.toggleBounce(self.googleMarker);self.clicked();});
